...
- Don't simplify Segment name to the point of losing meaning.
...
- **Usage contexts** must be provided in `usage_contexts` as an array of strings (same structure as **Characteristics**).
