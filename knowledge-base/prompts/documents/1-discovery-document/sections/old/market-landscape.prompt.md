...
- Every market trend, dynamic, and force must include a `confidence` field with one of: low | medium | high.
- `affected_target_segments` must use segment names drawn from the provided Target Users & Segments inputs.
